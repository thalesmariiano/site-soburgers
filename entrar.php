...
<head>
    ...
    <title>Só Pizzas Delivery</title>
...
<body class="scroll-smooth">
                ...
                <div class="authentication-steps"><span class="authentication-steps__title"></span>
                    <div class="steps-router">
                        <div
                            ...
                            <div class="cpfLogin sign-in-onboard mt-10" style="display: none;">
                                <h1 class="sign-in-onboard__title">Informe o seu cpf para continuar</h1>
                                <h2 class="sign-in-onboard__subtitle">Coloque apenas os números</h2>

                                <div class="mt-10">
                                    <input name="cpf" id="inputCpf" class="w-full bg-none outline-none input-cpf cpf"
                                        type="text" placeholder="CPF">
                                </div>

                                <div class="mt-5">
                                    <button type="button" id="btnLoginCpf" role="button"
                                        class="btn btn--link btn--size-m w-full btn-login-cpf btn-disabled" disabled
                                        label="Entrar com cpf">
                                        <span class="btn__label">Entrar com cpf</span>
                                    </button>
                                </div>
                            ...
                            <div class="sign-in-onboard socialLoginDiv">
                            ...
                            <div class="sign-in-onboard__btnContainer cpfdiv">
    ...
    <script src="arquivos/js/includes/jquery.maskedinput.min.js"></script>
    <script src="arquivos/js/includes/mask.js"></script>
    <script  type="module" src="arquivos/js/includes/login.js"></script>
    
    <script  type="module"  src="arquivos/js/cadastrar.js"></script>
